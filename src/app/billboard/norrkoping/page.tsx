...
const billboard = {
  id: 3,
  title: 'Norrköping Innerstad',
  views: 52000,
  size: '6,4 × 3,2 m',
  traffic: '52 000 blickar per dygn',
  price: 14000,
  priceUnit: 'vecka',
  images: ['/demo/3.jpg', '/demo/1.jpg', '/demo/2.jpg'],
  led: true,
  location: 'Norrköping',
  owner: {
    name: 'Johan Karlsson',
  ...
  description: `Mitt bland de röda industrifasaderna längs Kungsgatan, där spårvagnarna klingar och Motala Ström glittrar, reser sig en 6,4 × 3,2 m premium-LED. Skylten står precis i korsningen mot Drottninggatan – hjärtat av Norrköpings shoppingstråk – och möter både stadens puls och dess industri­romantiska siluett.

Här passerar i genomsnitt 52 000 blickar per dygn: morgonpendlare från Söderköping, studenter på väg mellan Campus Norrköping och Visualiseringscenter C, familjer som tar spårvagnen till Mirum Galleria och kulturpublik på väg till Louis de Geer-hallen. Trafikljuset vid övergångsstället ger upp till 9 sekunders stillastående exponering, vilket betyder att kreativa detaljer verkligen hinner landa.

Skylten är monterad i ögonhöjd över taket på spårvagnen, vilket ger obruten siktlinje för både förare och fotgängare. Den högupplösta panelen auto-dimmar efter solnedgången, så budskapet lyser klart utan att blända café-balkonger eller kvällsflanörer längs Strömmen.

Med knappt någon konkurrerande yta inom de innersta kvarteren, blir detta en exklusiv megafon i det kvartersliv som just nu sjuder av nyöppnade restauranger, tech-startups och kulturevenemang. Perfekt för varumärken som vill äga mötet mellan historisk autenticitet och samtida energi – på en plats där Norrköping varje dag påminner sig om sin framtid."`
};
...
export default function BillboardNorrkopingPage() {
